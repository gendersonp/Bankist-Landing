...
btnScrollTo.addEventListener('click', function (e) {
  ...
  //MODERN WAY TO SCROLL JUST IN MODERN BROWSERS
...
tabsContainer.addEventListener('click', function (e) {
  const clicked = e.target.closest('.operations__tab'); //what we clicked
  // console.log(clicked);
...
//   if (this.window.scrollY > initalCords.top) nav.classList.add('sticky');
//   else nav.classList.remove('sticky');
// });

//Sticky navigation with intersection obeserver
